...
export function EmptyDetailState({ isDarkMode = false, isCompactLayout = false, onPickPdf, onDropFile }: Props) {
  ...
  return (
    <View style={[styles.stateCardNeutral, isDarkMode && styles.stateCardNeutralDark]}>
      <View style={[styles.emptyDetailGrid, !isCompactLayout && styles.emptyDetailGridWide]}>
        <View style={styles.emptyDetailInfoColumn}>
          ...
          <View style={styles.emptyDetailChecklist}>
            <Text style={[styles.emptyDetailChecklistItem, isDarkMode && styles.emptyDetailChecklistItemDark]}>1. 상단에서 PDF 또는 Markdown 파일을 엽니다.</Text>
        ...
        <View style={styles.emptyDetailDropColumn}>
          <Pressable
            onPress={onPickPdf}
            style={[
          ...
          >
            ...
            <Text style={[styles.emptyDropZoneBody, isDarkMode && styles.emptyDropZoneBodyDark]}>
              드래그 앤 드롭으로 바로 열 수 있고, 클릭해 파일 선택창을 열 수도 있습니다.
            </Text>
