...
const HEAD_INJECTION = `
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="./icons/favicon-32.png?v=20260501-logo3">
    <link rel="apple-touch-icon" href="./icons/apple-touch-icon.png?v=20260501-logo3">
    ...
    <script>
      if ("serviceWorker" in navigator) {
        window.addEventListener("load", function () {
          navigator.serviceWorker.register("./sw.js?v=20260501-logo3").catch(function (error) {
