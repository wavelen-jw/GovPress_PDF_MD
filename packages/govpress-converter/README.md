...
공공문서의 표는 구조 복잡도에 따라 4단계로 자동 선택됩니다.

| 등급 | 조건 | 출력 |
|---|---|---|
| **Tier 1** | 단순 표 (병합 없음) | Markdown `\| \| \|` |
| **Tier 2** | rowspan만 있음 | Markdown (병합 셀 내용 반복) |
| **Tier 3** | colspan 포함 또는 중첩 표 | HTML `<table colspan rowspan>` |
| **Tier 4** | 80% 이상 빈 셀 (레이아웃용) | `[표: 내용 요약]` 또는 생략 |
